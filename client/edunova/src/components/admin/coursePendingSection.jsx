...
function CoursePendingSections() {
    ...
    useEffect(() => {
        axios.get('http://localhost:5000/api/admin/coursePending')
                    ...
                    {data.length === 0 ? (
                        <tbody>
                            <tr className="border-t">
                                <td className="p-4">No courses Pending</td>
                            </tr>
                        </tbody>
                    ) : (
                        <tbody>
                            {data.map((item, index) => (
                                <tr key={index} className="border-t">
                                    ...
                                    <td className="p-4 flex items-center gap-3">
                                        <img src={item.instructorId.avatar} alt={item.instructorId.name} className="w-8 h-8 rounded-full" />
