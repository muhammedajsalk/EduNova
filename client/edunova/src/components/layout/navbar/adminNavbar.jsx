    ...
    <nav className="bg-white shadow-sm px-6 py-4 w-full fixed top-0 left-0 z-50">
      <div className="flex items-center justify-between w-full max-w-7xl mx-auto">
        ...
        <ul className="hidden md:flex space-x-6 text-gray-700 font-medium">
          <li className="hover:underline decoration-emerald-600"><Link to={'/adminDashBoard'}>Home</Link></li>
          <li className="hover:underline decoration-emerald-600"><Link to={'/admin/studentsManagement'}>Users</Link></li>
          <li className="hover:underline decoration-emerald-600"><Link to={'/courseManagement'}>Courses</Link></li>
          <li className="hover:underline decoration-emerald-600"><Link to={'/admin/instructorManagement'}>Instructors</Link></li>
          <li className="hover:underline decoration-emerald-600"><Link to={'/adminRevenew'}>Revenue</Link></li>
        </ul>
      ...
      {isOpen && (
        <div className="md:hidden mt-4 space-y-4 px-2">
          <ul className="flex flex-col space-y-2 text-gray-700 font-medium">
            ...
            <li><Link to={'/adminRevenew'}>Revenue</Link></li>
          </ul>
