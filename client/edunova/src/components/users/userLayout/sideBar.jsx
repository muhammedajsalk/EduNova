...
const Sidebar = () => {
  ...
  { label: "Community Chat", icon: <Users size={20} />, path: "" },
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-50 transform w-72 bg-white border-r border-gray-200
      ...
      >
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm"
            />
          </div>
        </div>
        ...
        <nav className="p-6 space-y-1">
          {navItems.map((item, i) => (
            <button
              key={i}
              className="w-full flex items-center gap-3 p-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-all duration-200 group"
            >
              <span className="text-gray-500 group-hover:text-emerald-600 transition-colors">
                {item.icon}
              </span>
        ...
        <div className="p-6 space-y-3">
          <button className="w-full flex items-center gap-3 p-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-all duration-200 group">
          </button>
        </div>
