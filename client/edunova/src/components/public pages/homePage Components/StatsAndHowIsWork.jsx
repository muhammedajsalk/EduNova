  ...
  return (
    <section className="bg-white">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center px-6 py-16 max-w-7xl mx-auto">
        <div>
          <FaGraduationCap className="text-emerald-600 text-3xl mx-auto mb-2" />
          <h3 className="text-2xl font-bold text-gray-900">50,000+</h3>
          <p className="text-gray-500">Active Learners</p>
        </div>
        <div>
          <FaBook className="text-emerald-600 text-3xl mx-auto mb-2" />
        ...
        <div>
          <FaTrophy className="text-emerald-600 text-3xl mx-auto mb-2" />
