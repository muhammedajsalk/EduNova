  ...
  return (
    <section className="bg-white">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center px-6 py-16 max-w-7xl mx-auto">
        <div>
          <FaGraduationCap className="text-blue-600 text-3xl mx-auto mb-2" />
        ...
        <div>
          <FaTrophy className="text-blue-600 text-3xl mx-auto mb-2" />
      ...
      <div className="bg-gray-50 py-16 px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
          <div>
            <FaPlayCircle className="text-blue-600 text-4xl mx-auto mb-4" />
